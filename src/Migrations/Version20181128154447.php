 ...
 */
final class Version20181128154447 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oferta ADD juego_id INT NOT NULL, ADD usuario_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oferta DROP juego_id, DROP usuario_id');
    }
}
